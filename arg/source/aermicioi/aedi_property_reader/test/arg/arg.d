...
unittest {
	...
	auto T = ArgumentAccessorFactory!(const(string)[])();
	auto D = ArgumentInspectorFactory!(const(string)[])();
	...
	import std.stdio;
	writeln(c.locate!Placeholder(""));
	assert(c.locate!Placeholder("") == Placeholder(1.0, 2.0, 10, 20, "hello", ["ahoj", " ", "world!"]));
}