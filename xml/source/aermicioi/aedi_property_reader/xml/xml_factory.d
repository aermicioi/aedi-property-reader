...
**/
class XmlConvertorFactory(To, From : XmlElement = XmlElement) : ConvertorFactory!(XmlElement, To) {

    private {

        Locator!() locator_;
        XmlElement convertible_;
    }
    ...
    public {
        ...
        @property {
            ...
            **/
        	XmlConvertorFactory!(To, From) convertible(XmlElement convertible) @safe nothrow {
            ...
            Returns:
                FromType
            **/
        	XmlElement convertible() @safe nothrow {
		...
		**/
        To factory() {
            if (this.convertible.kind == XmlElement.Kind.element) {

                return fromXml!To(cast(Element) this.convertible());
            } else {
                import std.conv;

                return (cast(string) this.convertible).to!To;
            }
        }
    }
}
