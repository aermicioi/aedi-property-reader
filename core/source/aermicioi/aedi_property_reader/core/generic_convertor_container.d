...
class GenericConvertorContainer(FromType, alias DefaultConvertorFactory) :
    ...
    private {
        ConvertorFactory!(FromType, Object) defaultConvertor_;
    ...
    public {
        ...
        **/
        ...
        @property {
			...
			**/
            ...
            /**
            Set defaultConvertor

            Params:
                defaultConvertor = default convertor to be used to convert a property
            Throws:

            Returns:
                typeof(this)
            **/
            typeof(this) defaultConvertor(ConvertorFactory!(FromType, Object) defaultConvertor) @safe nothrow pure {
                this.defaultConvertor_ = defaultConvertor;

                return this;
            }

            /**
            Get defaultConvertor

            Returns:
                !(FromType, Object)
            **/
            ConvertorFactory!(FromType, Object) defaultConvertor() @safe nothrow pure {
                return this.defaultConvertor_;
            }
        }
		...
		**/
        Object get(string key) {
            ...
            ConvertorFactory!(FromType, Object) factory;

            if (!this.instantiated.has(key)) {
                if (!this.convertors.has(key)) {
                    if (this.defaultConvertor is null) {

                        throw new NotFoundException("Object with id " ~ key ~ " not found.");
                    }

                    factory = this.defaultConvertor;
                } else {

                    factory = this.convertors.get(key);
                }
        ...
        **/
        bool has(in string key) inout {
            return this.locator_.has(key) && (this.convertors.has(key) || (this.defaultConvertor_ !is null));
        }
